...
public:
  ...
  inline G4bool   DetectSchema()             const {return G4bool  (options.detectSchema);}
  inline G4String PreprocessGDMLSchemaLocation() const {return G4String(options.preprocessGDMLSchemaLocation);}
