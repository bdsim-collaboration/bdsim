...
*/
#ifndef BDSTIPCOLLIMATOR_H
#define BDSTIPCOLLIMATOR_H
...
class BDSTipCollimator: public BDSAcceleratorComponent
{
public:
  BDSTipCollimator(const G4String& name,
                   G4double        length,
                   ...
                   G4double    tipThicknessIn = 0,
                   G4bool      circularOuterIn = false);
  virtual ~BDSTipCollimator();
...
protected:
  ...
  G4Material* collimatorTipMaterial; ///< Tip material.
  ...
  G4Colour*   tipColour;          ///< Colour of collimator tip.
  G4double    tipThickness;       ///< Thickness of the collimator tip.
